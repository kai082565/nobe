...
class MiningDashboard:
    ...
    def _build_monitor_tab(self, parent) -> None:
        ...
        tk.Label(sf, text="狀態", width=9, anchor="w",
                 font=FONT_LB, bg=BG2, fg=FG_DIM).pack(side="left")
        self.dot = tk.Label(sf, text="●", font=("Segoe UI", 11), bg=BG2, fg=FG_DIM)
    ...
    def _build_settings_tab(self, parent) -> None:
        ...
        # ── 基本設定 ──────────────────────────────────────────────────────
        section("基本設定")
        self._e_worker = field("Worker 名稱", self.config.get("worker_name", "rig01"))
        ...
        self._btn_save = tk.Button(
            ...
            bg=ACCENT, fg=BG, relief="flat", font=("Segoe UI", 10, "bold"),
